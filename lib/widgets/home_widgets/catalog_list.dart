...
import 'package:flutter_new/pages/home_detail_page.dart';
import 'package:flutter_new/widgets/home_widgets/catalog_image.dart';
        ...
        Expanded(
          ...
          children: [
            ...
            ButtonBar(
              ...
              children: [
                "\$${catalog.price}".text.bold.xl.color(Vx.green600).make(),
